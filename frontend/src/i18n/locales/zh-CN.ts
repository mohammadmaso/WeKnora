export default {
  ...
  settings: {
    ...
    sandbox: {
      ...
      templateLoadHint: '填写集群连接后刷新模板。没有 Mohaymen EKMS 标准模板时点「创建」；改 DNS 或镜像后点「删除并重建」。',
      ...
      templateStepHint: '进入此步只会列出集群已有模板，不会自动创建。没有标准模板时点「创建 Mohaymen EKMS 标准模板」；改 DNS 或镜像后点「删除并重建」。模板就绪后才能继续。',
