export default {
  ...
  newUserGuide: {
    ...
    steps: {
      welcome: {
        title: 'Welcome to Mohaymen EKMS',
      ...
      knowledge: {
        ...
        desc: 'Everything starts here: upload documents, web pages or FAQs and Mohaymen EKMS parses and indexes them automatically. Click here to open knowledge bases.'
      },
      chat: {
  ...
  settings: {
    ...
    sandbox: {
      ...
      backendDescriptions: {
        ...
        docker: 'Keep a long-lived container per session on this Mohaymen EKMS host; scripts and files stay in that container',
      },
      ...
      templateLoadHint: 'Enter the cluster connection and refresh. If there is no Mohaymen EKMS standard template, click Create; after changing DNS or the image, click Delete and rebuild.',
      ...
      templateStepHint: 'This step only lists templates already on the cluster; it does not create one automatically. Click Create Mohaymen EKMS standard template if none exists, or Delete and rebuild after changing DNS or the image. You can continue after a template is ready.',
      ...
      templateUntaggedHint: 'The builds finished but none carries the default tag, so sandbox creation cannot resolve this template. Delete it in E2B and refresh; Mohaymen EKMS will rebuild it.',
  ...
  createChat: {
    title: 'Hi, I am Mohaymen EKMS — your knowledge, within reach',
  ...
  integrations: {
    ...
    api: {
      ...
      hmacSecretDesc: 'Same secret stored in Mohaymen EKMS; used only on your backend to sign JWTs—never send it as a request header.',
    ...
    chrome: {
      ...
      subtitle: 'For self-hosted Mohaymen EKMS: ask questions in a sidebar, clip web pages, and save Markdown notes into your knowledge bases while you browse.',
      ...
      steps: {
        ...
        port: {
          ...
          desc: 'On Mohaymen EKMS Desktop, set a fixed API port (e.g. 37841) in API Info so the URL stays stable across restarts.'
        },
        install: {
    ...
    claw: {
      ...
      subtitle: 'Import documents and run hybrid retrieval (vector + keyword) via the Mohaymen EKMS REST API—for uploads, URL imports, Markdown entries, and cross-KB search.',
      ...
      installCtaHint: 'Install Mohaymen EKMS Skill · opens in a new tab',
