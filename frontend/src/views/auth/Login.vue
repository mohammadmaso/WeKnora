<template>
  <div class="login-layout">
    ...
    <div class="header-logo">
      <img src="/logo.png" :alt="$t('common.productName')" class="logo-image" />
    </div>
...
.header-logo {
  ...
  background:
    ...
    linear-gradient(180deg, rgba(42, 47, 61, 0.88) 0%, rgba(18, 20, 26, 0.92) 100%);
  box-shadow:
    0 8px 24px rgba(10, 12, 18, 0.28),
